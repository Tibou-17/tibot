...
- :heavy_check_mark: Ajouter la gestion de la configuration par fichier (.ini ou .toml).
- :heavy_check_mark: Réorganiser le code de la classe Main pour le rendre modulaire.
